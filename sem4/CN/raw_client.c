...
/*
 * ASSIGNMENT 1, PROBLEM 2, part iii
 * This program is to create a raw datagram client socket to send a message to the server.
 */

/*
 * COMPILATION: gcc -Wall -g -o rc raw_client.c
 * EXECUTION: ./rc
 *
 */
...
int main()
{
	...
	sockfd = socket(PF_INET,SOCK_RAW,IPPROTO_UDP);//opening socket
