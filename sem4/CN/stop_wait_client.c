...
/*
 * ASSIGNMENT 2, PROBLEM 2, PART i
 * Implementing the Stop-n-wait protocol in C
 * This program is a UDP implementation of a client in a noiseless channel following the Stop-n-wait protocol
 */

/*
 * COMPILATION INSTRUCTIONS: gcc -Wall -g -o swc stop_wait_client.c
 * INVOCATION: ./swc
