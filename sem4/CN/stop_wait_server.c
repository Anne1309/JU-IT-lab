 ...
 * This program is a UDP implementation of a server in a noiseless channel following the Stop-n-wait protocol
 */

/*
 * COMPILATION INSTRUCTIONS: gcc -Wall -g -o swc stop_wait_server.c
 * INVOCATION: ./sws
 * To quit the program, type ^C in the terminal where the server is executing.
 */
